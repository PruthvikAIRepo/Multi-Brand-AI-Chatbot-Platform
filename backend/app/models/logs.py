from sqlalchemy import Column, String, Text, Boolean, Integer, Float, Enum, ForeignKey, DateTime
...
class RecommendationRuleLog(Base, UUIDMixin):
    ...
    concerns = Column(JSONB, default=[])
    matched_products = Column(JSONB, default=[])
    matched_count = Column(Integer, default=0)
    excluded_products = Column(JSONB, default=[])
